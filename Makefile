...
# Template: app
# Command: C:\Qt\6.2.0\mingw81_64\bin\qmake.exe -o Makefile physics-environment.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: physics-environment.pro C:/Qt/6.2.0/mingw81_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.2.0/mingw81_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile physics-environment.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
