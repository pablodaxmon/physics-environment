...
QT_MOC_LITERAL(50, 8), // "unidadTo"
QT_MOC_LITERAL(59, 14), // "valueCondition"
QT_MOC_LITERAL(74, 7), // "valueTo"
QT_MOC_LITERAL(82, 17), // "createdActionSlot"
QT_MOC_LITERAL(100, 12) // "cancelAction"

    },
    "CreateActionDialog\0createdAction\0\0"
    "unidadCondition\0unidadTo\0valueCondition\0"
    "valueTo\0createdActionSlot\0cancelAction"
};
...
static const uint qt_meta_data_CreateActionDialog[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Int, QMetaType::Int, QMetaType::Float, QMetaType::Float,    3,    4,    5,    6,
...
void CreateActionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->createdAction((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3])),(*reinterpret_cast< float(*)>(_a[4]))); break;
        ...
        {
            using _t = void (CreateActionDialog::*)(int , int , float , float );
...
// SIGNAL 0
void CreateActionDialog::createdAction(int _t1, int _t2, float _t3, float _t4)
{
